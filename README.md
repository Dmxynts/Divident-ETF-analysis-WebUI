...
![系统总览](webui/assets/Snipaste_2026-07-06_14-04-58.png)
...
打开浏览器访问 `http://127.0.0.1:8050`，所有分析模块均有独立交互页面，含图表可视化。
...
| 类别 | 库 |
|------|----|
| **量化模型** | numpy, pandas, scipy, statsmodels, scikit-learn |
| **A股数据** | AKShare |
| **HMM模型** | hmmlearn |
| **波动率建模** | arch (GARCH/EGARCH/GJR-GARCH) |
| **卡尔曼滤波** | pykalman |
| **可视化** | matplotlib, seaborn, plotly |
| **Web界面** | dash, dash-bootstrap-components |
| **缓存序列化** | pyarrow (Parquet) |
| **可选** | prophet (趋势分解) |
